...
//this.reply(m.chat, `🪙 NO TIENE MONEDAS DE ${wm}`, m)
this.sendMessage(m.chat, {text: `🪙 NO TIENE MONEDAS DE ${wm}`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: wm, previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
...
if (m.money)
m.reply(+m.money + ' 🪙 MONEDAS GASTADA(S)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: wm, thumbnail: gataImg, sourceUrl: md }}}}, tg)
